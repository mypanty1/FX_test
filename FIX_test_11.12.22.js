...
if(app.$store.getters['main/userData']?.username=='mypanty1'){
  const selector=randcode(20);
  createScriptCrcElement(`particles-js-src`,"https://cdn.jsdelivr.net/particles.js/2.0.0/particles.min.js");
  ...
  `);
  document.querySelector('#ptvtb-app').insertAdjacentHTML('beforebegin',`<div class="${selector}" id="${selector}"></div>`)

  setTimeout(()=>particlesJS?particlesJS(selector,{
    particles: {
      number: {
        value: 400,
        density: {
