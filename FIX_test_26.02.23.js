...
snow/index.js
@mypanty1
mypanty1 Update index.js
 1 contributor
781 lines (758 sloc)  31.4 KB
/*(function(){
...
Vue.component("SiteNodeInfo", {
  template:`<CardBlock name="SiteNodeInfo">
    ...
    <iframe v-if="address_id&&$root.username==='mypanty1'" :src="urlToInventory.url" style="border:none;width:100%;height:100%;"/>
  </CardBlock>`,
  props:{
    site:{type:Object},
  },
