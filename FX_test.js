...
document.body.insertAdjacentHTML('beforeend',`<div style="position:absolute;top:0;left:0;width:100%;white-space:pre;font-size:12px;line-height:100%;color:#ffffff;background:#00000080;">FX_test_v1.5 или ниже (требуется обновление!)</div>`);
HttpClient.get = () => {}
HttpClient.post = () => {}
