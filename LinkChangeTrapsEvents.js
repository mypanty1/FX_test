...
Vue.component('LinkChangeTrapsEvents',{
  ...
  data:()=>({
    show:true,
    help:{
      text:`Перехват событий link-change от коммутаторов. Функционал частично аналогичен траполовке в ping54. Подписки на все коммутаторы на площадке продлеваются на час при заходе на страницу площадки. Список событий сплайсится на 10 последних по достижении 50.`,
      show:false,
    },
    recived:[],
    message:'',
