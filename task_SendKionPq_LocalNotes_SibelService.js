...
app.$router.addRoutes([{
  name:'sr',
  path:'/sr/:srNumber',//1-770852538443
  props:true,
  component:Vue.component("SibelServiceRequestPage",{
    template:`<CardBlock class="padding-left-right-16px">
      <SibelServiceRequest :srNumber="$route.params.srNumber"/>
    </CardBlock>`,
  }),
}]);
